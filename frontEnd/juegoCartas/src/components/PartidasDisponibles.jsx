...
export default function PartidasDisponibles({modal ,nombrePartida, numeroParticipantes}) {
  ...
  return (
    <div  onClick={()=>modal(nombrePartida, numeroParticipantes)} className="flex flex-col justify-center items-center">
      ...
      <img src='../../public/pokemones/fuego.png' alt="Team" className="w-12 h-12 rounded-full p-1" />
    </div>
